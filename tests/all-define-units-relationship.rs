...
fn tests() {
    ...
    pass(&t, "1_is_1_mul_itself"); // id1 1 == id2 1 * __ 1  =>  expand_1_1(id2, id1)
    ...
    pass(&t, "1_is_2_mul_itself"); // id1 1 == id2 2 * __ 2  =>  expand_2_2(id2, id1)
    pass(&t, "1_is_3_mul_3"); // id1 1 == id2 3 * id3 3  =>  expand_3_3(id2, id3, id1)
    pass(&t, "1_is_3_mul_itself"); // id1 1 == id2 3 * __ 3  =>  expand_3_3(id2, id1)
    pass(&t, "1_is_2_cross_2"); // id1 1 == id2 2 X id3 2  =>  expand_cross_2(id2, id3, id1)
    pass(&t, "1_is_2_cross_itself"); // id1 1 == id2 2 X __ 2  =>  expand_cross_2(id2, id1)
    pass(&t, "3_is_3_cross_3"); // id1 3 == id2 3 X id3 3  =>  expand_cross_3(id2, id3, id1)
    pass(&t, "3_is_3_cross_itself"); // id1 3 == id2 3 X __ 3  =>  expand_cross_3(id2, id1)
